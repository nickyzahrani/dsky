                                ...
                                <div class="table-responsive">
                                    ...
                                    @foreach($admin as $hasil)
                                        <tr>
                                            ...
                                            <td>
                                            <div class="btn-group">
                                            <a href="{{ route('editadmin', $hasil->id) }}">
                                                <button class="btn btn-success" type="submit" style="margin-right: 5px;">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                            </a>
                                            <form action="{{ route('hapusadmin', $hasil->id) }}" method="POST" style="display:inline;">
                                                @csrf
                                                @method('delete')
                                                <button class="btn btn-danger" type="submit" value="Delete" onclick="return confirm('Yakin hapus data admin ini?')">
